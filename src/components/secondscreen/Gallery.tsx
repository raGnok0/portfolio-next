  ...
  return (
    <div className="mt-20 pb-36 rounded-b-full">
      ...
      >
        <div>
          <Image
            src="/portfolio-next/images/home-item-1.jpg"
            alt="Home Item 1"
            height={250}
            width={250}
        ...
        <div>
          <Image
            src="/portfolio-next/images/home-item-3.jpg"
            alt="Home Item 3"
            width={250}
            height={250}
            className="w-full h-auto object-cover"
      ...
      >
        ...
        <div>
          <Image
            src="/portfolio-next/images/home-item-6.jpg"
            alt="Home Item 6"
            height={250}
            width={250}
            className="w-full h-auto object-cover"
        ...
        <div>
          <Image
            src="/portfolio-next/images/home-item-8.jpg"
            alt="Home Item 8"
            height={250}
            width={250}
            className="w-full h-auto object-cover"
